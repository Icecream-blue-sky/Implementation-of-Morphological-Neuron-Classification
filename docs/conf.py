...
project = 'btmorph'
copyright = '2014, Ben Torben-Nielsen'
...
latex_documents = [
  ('index', 'btmorph.tex', 'btmorph Documentation',
   'Ben Torben-Nielsen', 'manual'),
]
...
man_pages = [
    ('index', 'btmorph', 'btmorph Documentation',
     ['Ben Torben-Nielsen'], 1)
]
...
texinfo_documents = [
  ('index', 'btmorph', 'btmorph Documentation',
   'Ben Torben-Nielsen', 'btmorph', 'One line description of project.',
   'Miscellaneous'),
]
